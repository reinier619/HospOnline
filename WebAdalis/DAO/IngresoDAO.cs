...
namespace HospOnline.DAO
{
    public class IngresoDAO
    {
        ...
        public int actualizar(IngresoDTO ingresoDTO)
        {
            int retorno = 0;
            SqlConnection conn = new SqlConnection(connectionString);

            string sql = "UPDATE INTO Ingreso ( estado, enfermedad, unidadID, salaID, camaID, descripcion, pacienteID, fecha_ingreso, hora_ingreso) values( @estado, @enfermedad, @unidadID, @salaID, @camaID, @descripcion, @pacienteID, @fecha_ingreso, @hora_ingreso)";
