...
namespace HospOnline.DAO
{
    public class DiagnosticoDAO
    {
        ...
        public int actualizar(DiagnosticoDTO diagnosticoDTO)
        {

            int retorno = 0;
            SqlConnection conn = new SqlConnection(connectionString);

            string sql = "UPDATE INTO Diagnostico ( descripcion, fecha_diagnostico, ingresoID ) values( @descripcion, @fecha_diagnostico, @ingresoID)";
        ...
        public DataTable readxIngreso(DiagnosticoDTO diagnosticoDTO)
        {
            ...
            sqlcmd.Parameters["@ingresoID"].Value = diagnosticoDTO.diagnosticoID;
