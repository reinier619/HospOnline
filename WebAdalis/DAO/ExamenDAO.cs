...
namespace HospOnline.DAO
{
    public class ExamenDAO
    {
        ...
        public int actualizar(ExamenDTO examenDTO)
        {
            int retorno = 0;
            SqlConnection conn = new SqlConnection(connectionString);

            string sql = "UPDATE INTO Examen ( nombre_examen, fecha_examen, resultado, ingresoID ) values( @nombre_examen, @fecha_examen, @resultado, @ingresoID)";
